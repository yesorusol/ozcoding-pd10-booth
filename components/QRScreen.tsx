      ...
      {step === "photo" ? (
        ...
        <div className="flex flex-col items-center gap-3">
          <button
            ...
            className="flex w-[17rem] items-center justify-center rounded-full border-2 border-cabinet-frame bg-btn-yellow py-3 font-marquee text-xl tracking-wide text-cabinet-frame shadow-soft transition active:translate-y-px"
          >
          ...
          {challengeHref ? (
            <Link
              ...
              className="flex w-[17rem] items-center justify-center gap-2 rounded-full border-2 border-cabinet-frame bg-btn-blue py-3 font-marquee text-xl tracking-wide text-white shadow-soft transition active:translate-y-px"
            >
              <span>챌린지 사진 도전</span>
