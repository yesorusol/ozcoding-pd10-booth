    ...
    >
      ...
      {step === "photo" ? (
        <button
          ...
          className="mt-1 rounded-full bg-btn-yellow px-10 py-3 font-marquee text-xl tracking-wide text-cabinet-frame shadow-soft transition active:translate-y-px"
        >
          QR 만들기
        </button>
      ) : (
        <div className="flex flex-col items-center gap-3">
          <button
            ...
            className="flex h-14 w-72 items-center justify-center rounded-full bg-btn-yellow py-3 font-marquee text-xl tracking-wide text-cabinet-frame shadow-soft transition active:translate-y-px"
          >
          ...
          {challengeHref ? (
            <Link
              ...
              className="flex h-14 w-72 items-center justify-center gap-2 rounded-full bg-btn-blue py-3 font-marquee text-xl tracking-wide text-white shadow-soft transition active:translate-y-px"
            >
              <span>챌린지 사진 도전</span>
